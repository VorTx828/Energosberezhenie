...
namespace Program
{
    public class Calc1 : Main
    {
        ...
        public double k_Tr()
        {
            ...
            return (0.8 + 1.6 * N_CO2 * 100000) * (1 - 0.00038 * Tg) / Math.Pow((100000 * N_CO2 + 100000 * N_CO2) * S(), 0.5);
        }
        public double e_g()
        {
            //(0,8+1,6*B5*100000)*(1-0,00038*B2)/((100000*B5+100000*B4)*G8)^0,5
        ...
        public double k_Tst()
        {
            return (0.8 + 1.6 * N_H20 * 100000) * (1 - 0.00038 * Tst) / Math.Pow((100000 * N_CO2 + 100000 * N_CO2) * S(), 0.5);
        }
        public double ar()
        {
